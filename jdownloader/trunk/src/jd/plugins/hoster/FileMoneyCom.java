...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "filemoney.com" }, urls = { "https?://(www\\.)?filemoney\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class FileMoneyCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://filemoney.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(filemoney\\.com)";
    ...
    public FileMoneyCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private void waitTime(long timeBefore, final DownloadLink downloadLink) throws PluginException {
        ...
        /** Ticket Time */
        final String ttt = new Regex(correctedBR, ">Wait <span id=\"[a-z0-9]+\">(\\d+)</span>").getMatch(0);
        if (ttt != null) {
    ...
    private void fixFilename(final DownloadLink downloadLink) {
        ...
        if (newExtension != null && !oldName.endsWith(newExtension)) {
            ...
            downloadLink.setFinalFileName(oldName);
        }
    }
