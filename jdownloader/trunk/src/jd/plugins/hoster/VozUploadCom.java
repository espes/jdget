...
@HostPlugin(revision = "$Revision$", interfaceVersion = 2, names = { "vozupload.com" }, urls = { "https?://(www\\.)?vozupload\\.com/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 2 })
@SuppressWarnings("deprecation")
public class VozUploadCom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://vozupload.com";
    // domain names used within download links.
    private final String               DOMAINS                      = "(vozupload\\.com)";
     ...
     * */
    public VozUploadCom(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws Exception {
        ...
        if (cbr.containsHTML("(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|<li>The file (expired|deleted by (its owner|administration))|<title> Free Download  \\- VOZupload\\.com</title>)")) {
    ...
    public AccountInfo fetchAccountInfo(final Account account) throws Exception {
        ...
        if (cbr.containsHTML(">Upgrade to premium</b>")) {
