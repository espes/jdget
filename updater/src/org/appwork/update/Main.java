...
import org.appwork.update.gui.JDStandaloneUpdaterGui;
...
public class Main {
    static {
        Application.setApplication(".appwork_updater");
        ...
        AWUTheme.I().setNameSpace("org/appwork/updater/");
        AWUTheme.I().setTheme(Setup.ICON_THEME.getValue());
    ...
    public static void main(final String[] args) throws Throwable {
        try {
                                ...
                                public void actionPerformed(final ActionEvent e) {
                                    ...
                                    if (rest == null || rest.trim().length() == 0) {
                                        if (CrossSystem.isWindows()) {
                                            rest = Setup.CFG.getMainExe() + " -rfu -scan";
                                        } else if (CrossSystem.isLinux()) {
                                            rest = CrossSystem.getJavaBinary() + " -jar " + Setup.CFG.getMainJar() + " -rfu -scan";
                                        } else {
                                            rest = "open ../../../" + Setup.CFG.getMainMacApp() + " -rfu";
                                        }
            ...
            Dialog.getInstance().showExceptionDialog("Error", "An Error occured!", e);
           ShutdownController.getInstance().requestShutdown();
        }
    }
