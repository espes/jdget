...
public class PasswordDialog extends AbstractDialog implements KeyListener, MouseListener {
    ...
    public JComponent layoutDialogContent() {
        ...
        contentpane.add(new JLabel(Loc.L("com.rapidshare.utils.swing.dialog.Dialog.PasswordDialog.old", "Old Password:")));
        ...
        contentpane.add(new JLabel(Loc.L("com.rapidshare.utils.swing.dialog.Dialog.PasswordDialog.new", "New Password:")));
        if (BinaryLogic.containsAll(flagMask, Dialog.STYLE_LARGE)) {
        ...
        contentpane.add(new JLabel(Loc.L("com.rapidshare.utils.swing.dialog.Dialog.PasswordDialog.confirm", "Confirm Password:")));
        if (BinaryLogic.containsAll(flagMask, Dialog.STYLE_LARGE)) {
