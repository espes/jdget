...
public class HTTPHeaderMap<V> implements Map<String, V> {
        ...
        public Iterator<String> iterator() {
            ...
            return new Iterator<String>() {
                ...
                public String next() {
                    ...
                    if (next != null) { return next.getHttpHeaderFieldName(); }
                    return null;
                }
    ...
    protected static class HTTPHeaderMapEntry {
        ...
        public boolean equals(final Object obj) {
            ...
            if (!(obj instanceof HTTPHeaderMapEntry)) { return false; }
    ...
    public boolean containsKey(final Object key) {
        if (key != null && key instanceof String) { return this.internalMap.containsKey(new HTTPHeaderMapEntry((String) key)); }
        return false;
    }
    ...
    public Set<java.util.Map.Entry<String, V>> entrySet() {
        ...
        return new Set<Map.Entry<String, V>>() {
            ...
            private Entry<HTTPHeaderMapEntry, V> get(final Object o) {
                ...
                if (e.getKey() != null && !(e.getKey() instanceof String)) { return null; }
                ...
                while (it.hasNext()) {
                    ...
                    if (key == null && e.getKey() == null || key.getHttpHeaderFieldName().equalsIgnoreCase((String) e.getKey())) {
                        if (next.getValue() == e.getKey() || next.getValue() != null && next.getValue().equals(e.getValue())) { return next; }
                    }
                }
                return null;
            }
            ...
            public Iterator<java.util.Map.Entry<String, V>> iterator() {
                ...
                return new Iterator<Map.Entry<String, V>>() {
                    ...
                    public Map.Entry<String, V> next() {
                        final Entry<HTTPHeaderMapEntry, V> next = it.next();
                        if (next != null) { return HTTPHeaderMap.this.convertFromEntry(next); }
                        return null;
                    }
            ...
            public boolean remove(final Object o) {
                ...
                if (entry != null) { return HTTPHeaderMap.this.internalMap.entrySet().remove(entry); }
                return false;
            }
    ...
    public V get(final Object key) {
        if (key == null) { return this.internalMap.get(null); }
        if (key instanceof String) { return this.internalMap.get(new HTTPHeaderMapEntry((String) key)); }
        return null;
    }
    ...
    public V put(final String key, final V value) {
        if (key == null) { return this.internalMap.put(null, value); }
    ...
    public V remove(final Object key) {
        if (key == null) { return this.internalMap.remove(null); }
        if (key instanceof String) { return this.internalMap.remove(new HTTPHeaderMapEntry((String) key)); }
        return null;
    }
