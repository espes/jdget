 ...
 *
 */
public class LongListHandler extends ListHandler<long[]> {

    /**
     * @param storageHandler
     * @param key
     */
    public LongListHandler(StorageHandler<?> storageHandler, String key) {
    ...
    protected void initHandler() {
        try {
            defaultValue = getAnnotation(DefaultLongArrayValue.class).value();
    ...
    protected Class<? extends Annotation>[] getAllowedAnnotations() {       
        return (Class<? extends Annotation>[]) new Class<?>[]{DefaultLongArrayValue.class};
    }
    /* (non-Javadoc)
