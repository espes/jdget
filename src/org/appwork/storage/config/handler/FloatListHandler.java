 ...
 *
 */
public class FloatListHandler extends ListHandler<float[]> {

    /**
     * @param storageHandler
     * @param key
     */
    public FloatListHandler(StorageHandler<?> storageHandler, String key) {
    ...
    protected void initHandler() {
        try {
            defaultValue = getAnnotation(DefaultFloatArrayValue.class).value();
    ...
    protected Class<? extends Annotation>[] getAllowedAnnotations() {       
        return (Class<? extends Annotation>[]) new Class<?>[]{DefaultFloatArrayValue.class};
    }
    /* (non-Javadoc)
