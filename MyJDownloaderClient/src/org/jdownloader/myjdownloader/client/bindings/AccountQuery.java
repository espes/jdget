...
public class AccountQuery extends AbstractJsonData {
     ...
     * @param valid
     */
    public AccountQuery(final int startAt, final int maxResults, final boolean userName, final boolean validUntil, final boolean trafficLeft, final boolean trafficMax, final boolean enabled, final boolean valid) {
        super();
